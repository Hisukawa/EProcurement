...
class PARItems extends Model
{
    ...
    protected $fillable = ['par_id', 'recipient', 'recipient_division', 'estimated_useful_life', 'inventory_item_id','inventory_item_number', 'recipient', 'ppe_sub_major_account', 'general_ledger_account', 'series_number', 'office', 'school', 'quantity', 'unit_cost', 'total_cost', 'property_no'];

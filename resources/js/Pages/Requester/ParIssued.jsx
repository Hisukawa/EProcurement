...
export default function ParIssued({ par }) {
  ...
  return (
    <RequesterLayout header="Schools Division Office - Ilagan | Issued PAR">
      <Head title="Issued PAR"/>
      <RequesterIssuedTabs/>
      ...
      <div className="bg-white shadow rounded-lg p-6 space-y-4">
        ...
        <div className="overflow-x-auto">
          <table className="w-full border border-gray-300 rounded-lg text-sm">
            ...
            <tbody>
              {filteredPar && filteredPar.length > 0 ? filteredPar.map((record, index) => {

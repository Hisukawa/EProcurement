...
export default function RisIssued({ ris }) {
  ...
  const filteredRis = ris?.data?.filter(record => {
    const matchesSearch = search === '' ||
      record.ris_number?.toLowerCase().includes(search.toLowerCase()) ||
  ...
  return (
    <RequesterLayout header="Schools Division Office - Ilagan | Issued RIS">
      <Head title="Issued RIS"/>
      <RequesterIssuedTabs/>

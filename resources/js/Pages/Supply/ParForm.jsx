        ...
        <div className="p-5 border rounded-md bg-green-50">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <textarea value={data.remarks} onChange={(e) => setData("remarks", e.target.value)} rows="3" placeholder="Enter remarks (optional)" className="w-full mt-1 px-3 py-2 border border-gray-300 rounded-md shadow-sm"/>
            </div>
          </div>
        </div>

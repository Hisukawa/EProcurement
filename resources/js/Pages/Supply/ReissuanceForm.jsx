...
export default function ReissuanceForm({
  record,
  user,
  type,
  rrsp_number,
  ...
  const handleConfirmSave = () => {
    post(route("supply_officer.submit_reissuance"), {
      ...data,
      preserveScroll: true,
      onSuccess: () => {
        setConfirmDialogOpen(false);
        toast({
          title: "Reissuance Recorded",
    ...
    <SupplyOfficerLayout header="Schools Division Office - Ilagan | Reissuance Form">
      ...
      <Dialog open={confirmDialogOpen} onOpenChange={setConfirmDialogOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            <DialogTitle>Confirm Reissuance</DialogTitle>
            <DialogDescription>
              Are you sure you want to record this reissuance?
            </DialogDescription>
          </DialogHeader>
          <DialogFooter className="mt-4">
            ...
            <Button onClick={handleConfirmSave}>Yes, Record Reissuance</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
    </SupplyOfficerLayout>
